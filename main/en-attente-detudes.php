          ...
          <div class="row">
            ...
            <div style="background-color: white; border-radius: 15px; padding:20px; margin-bottom: 30px;">
              <div class="datatables">
                ...
                <h2>En attente d'études</h2>
                <div class="table-container">
                  <?php
                  include 'db.php'; // Include database connection

                  // Fetch clients from database
                  $sql = "SELECT * FROM client WHERE statut = 'En attente'";
                      ...
                      if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                          echo "<tr>
                                          ...
                                          <td>
                                            <a href='consulter-en-attente-detude.php?id={$row['id']}' class='btn btn-info'>Consulter</a>
                                          </td>
                                        </tr>";
                        }
                      } else {
