    ...
    <body>
        ...
        <div class="toast toast-onload align-items-center text-bg-primary border-0" role="alert" aria-live="assertive"
            ...
            <div class="toast-body hstack align-items-start gap-6">
                ...
                <div>
                    <h5 class="text-white fs-3 mb-1">bienvenue <?= htmlspecialchars($client['nom']); ?></h5>
                            ...
                            <div class="card">
                                <div class="card-body p-2">
                                    <div class="d-flex justify-content-between">
                                        <h2 class="p-1 mt-3">Statut: <?= htmlspecialchars($client['statut']); ?></h2>
                                        <h2 class="p-1 mt-3">Demande <?= htmlspecialchars($client['id']); ?></h2>
                                    </div>
                                    <form action="#">
