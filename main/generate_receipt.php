...
// Title
$pdf->Cell(190, 20, "$text de Paiement", 0, 1, 'C');
...
$pdf->Cell(190, 10, "Montant Payé: " . number_format($amount, 2) . " EUR", 0, 1, 'L');
...
// Output PDF
$pdf->Output("D", "Reçu_Paiement_$client_id.pdf"); // Force download
?>